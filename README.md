# One-Word Environment Domain Names (59,534)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-59%2C534%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **59,534 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 59,534 domains · **Median ask:** $603.97 · **High-demand under $2,500:** 287
...
This repository is the public extract for the exact Unique Domains search represented by `https://unique.domains/domains/sector/environment`.

### Files

- `environment.csv`, public CSV extract (1,000 rows)
- `environment.json`, public JSON extract (1,000 rows)
...
df = pd.read_csv("https://raw.githubusercontent.com/UniqueDomains/environment-oneword-domains/main/environment.csv")
print(df.head())
```
...
| ----------------- | --------- | ---------- | ------------- | -------------- | ------ | ------ | ---------------- |
| nature.forex      | available | $11.98     | $133.98       | high           | low    | 6      | namecheap        |
| fauna.asia        | available | $1.98      | $18.98        | high           | low    | 5      | namecheap        |
| energy.berlin     | resell    | $6,371.43  | $75.99        | high           | medium | 6      | name.com         |
| fauna.mobile      | premium   | $375       | $375          | high           | low    | 5      | name.com         |
| fauna.barcelona   | available | $38.98     | $38.98        | high           | low    | 5      | namecheap        |
| energy.foundation | resell    | $260       | $260          | high           | medium | 6      | Porkbun LLC      |
| solar.diy         | premium   | $1,820     | $2,600        | high           | high   | 5      | namecheap        |
| fauna.forex       | available | $11.98     | $133.98       | high           | low    | 5      | namecheap        |
| energy.gallery    | resell    | $85.80     | $85.80        | high           | medium | 6      | Porkbun LLC      |
| solar.flowers     | premium   | $832       | $832          | high           | high   | 5      | namesilo         |
| fauna.talk        | available | $38.99     | $38.99        | high           | low    | 5      | namesilo         |
| energy.luxe       | resell    | $37,060.64 | —             | high           | medium | 6      | Dynadot Inc      |
| solar.host        | premium   | $3,250     | $6,500        | high           | high   | 5      | namecheap        |
| fauna.xxx         | available | $69.98     | $154.98       | high           | low    | 5      | namecheap        |
| energy.me         | resell    | $5,750     | $27.99        | high           | medium | 6      | GoDaddy.com, LLC |
| solar.press       | premium   | $1,950     | $3,900        | high           | high   | 5      | namecheap        |
| fauna.you         | available | $22.99     | $22.99        | high           | low    | 5      | namesilo         |
| energy.town       | resell    | $42.90     | $42.90        | high           | medium | 6      | Porkbun LLC      |
| solar.sucks       | premium   | $2,658.67  | $2,658.67     | high           | high   | 5      | namesilo         |
| solar.car         | available | $1,999.99  | $2,199        | high           | high   | 5      | namesilo         |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 59,534 live domains                        |
...
This list gathers one-word domain names connected to the environment theme, drawn from 506 different TLDs. With 99,465 domains and a median ask of $807, the set ranges from mainstream extensions to niche endings, pairing concrete words like ground, acid, life, and biological with varied domain types. Whether you're comparing options for a new venture or scanning for undervalued names, this selection stays focused on single, ownable words tied to environmental themes.

- 99,465 one-word domains matched to the environment keyword
- 506 TLDs represented, from .eco to niche extensions
- Median ask across the set: $807
- Brandable single words like ground, acid, and biological
...
> Unique Domains. *One-Word Environment Domain Names*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
